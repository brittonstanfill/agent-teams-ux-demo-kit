...
```bash
git add demo-output/single-agent-baseline demo-output/single-agent-baseline.md
...
```bash
git add demo-output/role-reports demo-output/prototype demo-output/final-recommendation.md
